...
class AdminLogin extends BaseLogin
{
    public function mount(): void
    {
        ...
        if (session()->pull('admin_access_denied')) {
            Notification::make()
                ->title('Access Denied')
                ->body('Only admin accounts can access this panel.')
                ->warning()
                ->send();
        }
    }
    ...
    public function authenticate(): ?LoginResponse
    {
        ...
        if ($user instanceof FilamentUser && ! $user->canAccessPanel(Filament::getCurrentOrDefaultPanel())) {
            ...
            Notification::make()
                ->title('Access Denied')
                ->body('Only admin accounts can access this panel. Please login using an admin account.')
                ->warning()
                ->send();

            throw ValidationException::withMessages([
                'data.email' => __('Access denied. Only admins can access this panel.'),
            ]);
        }
